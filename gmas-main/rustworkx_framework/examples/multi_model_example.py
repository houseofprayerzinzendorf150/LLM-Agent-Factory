...
ORGANIZER_CONFIG = {
    "api_key": os.getenv("ORGANIZER_LLM_API_KEY", os.getenv("LLM_API_KEY", "")),
    "base_url": os.getenv("ORGANIZER_LLM_BASE_URL", os.getenv("LLM_BASE_URL", "https://api.openai.com/v1")),
    "model_name": os.getenv("ORGANIZER_LLM_MODEL", os.getenv("LLM_MODEL", "gpt-4")),
}
